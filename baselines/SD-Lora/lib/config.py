...
root.dtask.length = 5
root.dtask.n_g_prompts = 5
root.dtask.sinkhorn_linear = 0
root.dtask.top_k = 4
root.dtask.M = 10
root.dtask.skill_dim = 100
...
root.dtask.num_experts = 10
root.dtask.vision_ia3_full = False
root.dtask.vision_ia3_blocks = []
root.dtask.text_ia3_full = False
root.dtask.text_ia3_blocks = []
