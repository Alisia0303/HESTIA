...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--lr', type=float, default=0.1, metavar='LR', help='learning rate (default: 0.03)')
    ...
    subparsers.add_argument('--dataset', default='Split-VTAB', type=str, help='dataset name')
