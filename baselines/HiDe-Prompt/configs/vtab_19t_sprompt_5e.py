...
def get_args_parser(subparsers):
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='./local_datasets/vtab_data/', type=str, help='dataset path')
    subparsers.add_argument('--dataset', default='VTAB19T', type=str, help='dataset name')
    ...
    subparsers.add_argument('--nb_classes', type=int, default=190)