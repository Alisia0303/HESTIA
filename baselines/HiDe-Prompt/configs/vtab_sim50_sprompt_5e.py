...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--original_model', default='vit_base_patch16_224', type=str, metavar='OMODEL', help='Name of model to train')
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='../haha_lora/local_datasets/vtab_data/', type=str, help='dataset path')
    subparsers.add_argument('--dataset', default='VTAB5T-Sim50', type=str, help='dataset name')
    ...
    subparsers.add_argument('--device', default='cuda:0', help='device to use for training / testing')
    ...
    subparsers.add_argument('--length', default=40, type=int, )
    ...
    subparsers.add_argument('--nb_classes', type=int, default=196)