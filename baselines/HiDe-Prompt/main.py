...
def get_args():
    ...
    elif config == 'vtab_sim50_sprompt_5e':
        from configs.vtab_sim50_sprompt_5e import get_args_parser
        config_parser = subparser.add_parser('vtab_sim50_sprompt_5e')
    elif config == 'vtab_sim50_l2p':
        from configs.vtab_sim50_l2p import get_args_parser
        config_parser = subparser.add_parser('vtab_sim50_l2p')
    elif config == 'vtab_sim50_hideprompt_5e':
        from configs.vtab_sim50_hideprompt_5e import get_args_parser
        config_parser = subparser.add_parser('vtab_sim50_hideprompt_5e')
    elif config == 'vtab_sim50_dualprompt':
        from configs.vtab_sim50_dualprompt import get_args_parser
        config_parser = subparser.add_parser('vtab_sim50_dualprompt')
    elif config == 'vtabsmall_sprompt_5e':
        from configs.vtabsmall_sprompt_5e import get_args_parser
        config_parser = subparser.add_parser('vtabsmall_sprompt_5e', help='VTAB small s-prompt configs')
    elif config == 'vtabsmall_hideprompt_5e':
        from configs.vtabsmall_hideprompt_5e import get_args_parser
        config_parser = subparser.add_parser('vtabsmall_hideprompt_5e', help='VTAB small hide-prompt configs')
    elif config == 'vtabsmall_dualprompt_5e':
        from configs.vtabsmall_dualprompt_5e import get_args_parser
        config_parser = subparser.add_parser('vtabsmall_dualprompt_5e', help='VTAB small dual-prompt configs')
    elif config == 'vtab_19t_sprompt_5e':
        from configs.vtab_19t_sprompt_5e import get_args_parser
        config_parser = subparser.add_parser('vtab_19t_sprompt_5e')
    else:
