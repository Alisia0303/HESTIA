...
python -m torch.distributed.launch \
        ...
        --batch-size 32 \
        --data-path ./datasets/ \
        --output_dir ./output/img_r_sup21k_multi_centroid_mlp_2_seed42 \
        --epochs 20 \
        --sched constant \
        --seed 42 \
        --train_inference_task_only \
...
python -m torch.distributed.launch \
	...
	--sched step \
	--larger_prompt_lr \
	--trained_original_model ./output/img_r_sup21k_multi_centroid_mlp_2_seed42 \
	--output_dir ./output/img_r_vit_pe_seed42